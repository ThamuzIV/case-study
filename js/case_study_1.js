...
unlock =["nameMenu","sexMenu","classMenu","phoneMenu","emailMenu"],
data=[],
...
function showMenuUser() {
    ...
    document.getElementById("classMenu").value = dataClassStudy[id];
    document.getElementById("phoneMenu").value = dataNumbePhone[id];
